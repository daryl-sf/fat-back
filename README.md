...
- Create two apps on Fly, one for staging and one for production:
  ...
  ```sh
  fly apps create fat-back-b40a
  fly apps create fat-back-b40a-staging
  ```
...
- Add a `SESSION_SECRET` to your fly app secrets, to do this you can run the following commands:
  ...
  ```sh
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app fat-back-b40a
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app fat-back-b40a-staging
  ```

  > **Note:** When creating the staging secret, you may get a warning from the Fly CLI that looks like this:
  >
  > ```
  > WARN app flag 'fat-back-b40a-staging' does not match app name in config file 'fat-back-b40a'
  > ```
  >
...
- Create a database for both your staging and production environments. Run the following:
  ...
  ```sh
  fly postgres create --name fat-back-b40a-db
  fly postgres attach --app fat-back-b40a fat-back-b40a-db

  fly postgres create --name fat-back-b40a-staging-db
  fly postgres attach --app fat-back-b40a-staging fat-back-b40a-staging-db
  ```
